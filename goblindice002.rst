...
.. note:: Warning
    ...
    If the defense values for both players are much higher than the attack values, it can happen that the program caluculate for a long time ("hangs") showing only a black screen. 
