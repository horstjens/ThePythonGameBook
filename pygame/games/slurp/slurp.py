...
class PygView(object):
    ...
    def __init__(self, width=640, height=400, worldwidth=2000, worldheight=2000, mx=0, my=0, zoom=1.0, fps=30, grid=50):
        ...
        self.background = pygame.Surface((self.worldwidth, self.worldheight)).convert()
    ...
    def run(self):
        ...
        while running:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_RIGHT:
                        self.mx += 100
                        if self.mx > self.worldwidth - self.width:
                            self.mx = self.worldwidth - self.width
                    ...
                    if event.key == pygame.K_DOWN:
                        self.my += 100
                        if self.my > self.worldheight - self.height:
                            selfmy =  self.worldheight - self.height      
            ...
            # ----------- clear screen ------------------
            # ---- scroll world ----
            distx = int(self.width / 2) - pygame.mouse.get_pos()[0]
            disty = int(self.height /2) - pygame.mouse.get_pos()[1]
            #self.mx += distx
            #self.my += disty
            #self.
            self.screen.blit(self.worldbackground, (-self.mx, -self.my))  
